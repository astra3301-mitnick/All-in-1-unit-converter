...
root = Tk()
root.title('ALL IN ONE CONVERTER by Rahul')
root.geometry("450x400+100+200")
labelfont = ('ariel', 100, 'bold')
l=Label(root,text='ALL IN ONE CONVERTER ©Rahul',font = ("Arial", 15, "italic"), justify=CENTER)
l.place(x=80,y=20)

widget = Button(None, text="QUIT", bg="yellow", fg="blue",font = ("Arial", 14, "bold"), relief = SUNKEN, bd=5, justify = CENTER, highlightbackground = "red", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=root.destroy).place(x=350,y=350)
#=========================================xxxxxxxxxxxx=========================================================================================================================================================================================================================================
...
def WeightConverter():
    ...
    titleLabel = Label(mainframe, text="Weight Converter", font=("Arial", 25, "bold"), justify=CENTER).grid(column=1,
                                                                                                            row=1)
    ...
    widget = Button(None, text="QUIT", bg="yellow", fg="blue", font=("Arial", 14, "bold"), relief=SUNKEN, bd=5,
                    justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="green",
                    activeforeground="blue", command=root.destroy)
